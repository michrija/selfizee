 ...
 *
 */
class ChampOptionsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'FK_champ_options' => ['type' => 'index', 'columns' => ['champ_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'FK_champ_options' => ['type' => 'foreign', 'columns' => ['champ_id'], 'references' => ['champs', 'id'], 'update' => 'cascade', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
