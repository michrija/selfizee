...
/**
 * CatalogueCadresFixture
 *
 */
class CatalogueCadresFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'chemin' => ['type' => 'text', 'length' => null, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null],
        'nbr_pose' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'type_cadre' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'nbr_pose' => 1,
                'type_cadre' => 'Lorem ipsum dolor sit amet',
                'format_id' => 1,
                'evenement_id' => 1,
                'created' => '2019-09-12 06:44:08',
                'modified' => '2019-09-12 06:44:08'
            ],
        ];
        parent::init();
    }
