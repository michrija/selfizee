...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'galerie_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        '_indexes' => [
            ...
            'fk_users_evenements1_idx' => ['type' => 'index', 'columns' => ['evenement_id'], 'length' => []],
            'fk_users_galeries1_idx' => ['type' => 'index', 'columns' => ['galerie_id'], 'length' => []],
        ...
        '_constraints' => [
            ...
            'fk_users_evenements1' => ['type' => 'foreign', 'columns' => ['evenement_id'], 'references' => ['evenements', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
            'fk_users_galeries1' => ['type' => 'foreign', 'columns' => ['galerie_id'], 'references' => ['galeries', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2018-07-20 12:46:32',
                'modified' => '2018-07-20 12:46:32',
                'role_id' => 1,
                'evenement_id' => 1,
                'galerie_id' => 1,
                'client_id' => 1
