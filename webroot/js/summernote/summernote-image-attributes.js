  ...
  $.extend($.summernote.plugins, {
    'imageAttributes': function (context) {
      ...
      this.initialize = function () {
        ...
        var body = '<ul class="nav nav-tabs">' + //nav note-nav nav-tabs note-nav-tabs
                   '  <!--<li class="nav-item"><a class="nav-link" href="#note-imageAttributes' + timestamp + '" data-toggle="tab">' + lang.imageAttributes.tabImage + '</a></li>-->' +
        ...
        body +=    '</ul>' +
                   ...
                   // Tab 2
                   '  <!--<div class="tab-pane container" id="note-imageAttributes-attributes' + timestamp + '">' + //note-tab-pane
                   ...
                   '  </div>-->' +
                   // Tab 3
                   '  <div class="tab-pane container active" id="note-imageAttributes-link' + timestamp + '" role="tabpanel">' +
                   ...
                   '    <small class="help-block note-help-block text-right">' + lang.imageAttributes.linkTargetInfo + '</small>' +
                        // Source de l"image cachee
                   '    <div class="note-form-group form-group note-group-imageAttributes-url hide">' +
...
//                   '        </span>' +
                   '      </div>' +
                   '    </div>' +
                      // Fin Source de l"image cachee
                   '  </div>';
      if (options.imageAttributes.disableUpload == false) {
                   // Tab 4
        body +=    '  <div class="tab-pane container" id="note-imageAttributes-upload' + timestamp + '"  role="tabpanel">' +
        ...
        // Tab 1
        body +=    '  <!--<div class="tab-pane container active" id="note-imageAttributes' + timestamp + '"  role="tabpanel">' + //fade in
