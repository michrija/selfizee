            ...
            <?= $this->Form->create($configBorne, ['type' => 'file',"id"=>""]) ?>
                ...
                <div class="form-body">
                    <h4 class="">Etape 1 : Animations</h4>
                     ...
                     <div class="col-md-12">
                        <h5 class="">Configuration animations : </h5>
                            ...
                            <?php 
                                $url_cadre = null;
                                if(!empty($configBorne->cadres)){
                                        $fileName = $configBorne->cadres[0]->file_name;
                            ...
                            <h6 class="">Incrustation fond vert : </h6>
                                ...
                                <!--<div class="col-md-4 form-group">
                                    <input  type="file" name="image_fond_verts_files[]" class="dropify_fond_verts" accept=".jpg, .jpeg">
                                </div>-->                               
                                <div class="dropzone kl_blocDropzone cf_images_fond_vert hide" id="id_images_fond_vert"></div>
                    ...
                    ?>
                     <div class="col-md-12">
                         <?php                        
                            echo $this->Form->control('choix_fond_page_accueil', ['label' => '<strong>Fond de page</strong>', 'escape' => false, 'options' => $option_fond_page, 'value' => $choix_accuiel_fond_page, 'id' => 'id_choix_fond_page_accueil']); 
