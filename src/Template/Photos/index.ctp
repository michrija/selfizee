...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        <li class="heading"><?= __('Actions') ?></li>
             <li><?= $this->Html->link(__('Import photo'), ['action' => 'import', $evenemt->id]) ?></li>
    ...
    <table cellpadding="0" cellspacing="0">
        <thead>
            <tr>
                ...
                <th scope="col"><?= $this->Paginator->sort('is_postable_on_facebook') ?></th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?= h($photo->is_postable_on_facebook) ?></td>
                <td><?= h($photo->deleted) ?></td>
                <td><?= h($photo->created) ?></td>
                <td><?= h($photo->modified) ?></td>
                <td><?= $photo->has('evenement') ? $this->Html->link($photo->evenement->id, ['controller' => 'Evenements', 'action' => 'view', $photo->evenement->id]) : '' ?></td>
                <td class="actions">
