...
<div class="container">
    <div class="kl_formCommentaire">
        ...
        <?= $this->Form->create($galerieCommentaire, ['url' => [], 'id'=>'galerieCommentaire', 'class'=>'kl_commentaire']) ?>
        <?php
        ...
        <?= $this->Form->submit(__('Commenter'),['id'=>'id_sendCommentaire',"class"=>"pull-right", "disabled" => "disabled"]) ?>
