        ...
        <div class="card-body">
            <?= $this->Form->create($user, ['type' => 'file']) ?>
                <div class="form-body">
                    ...
                    <div class="col-md-4">                      
                        <?php  echo $this->Form->control('password_visible',['label'=>'Mot de passe','type'=>'text', 'id'=>'password_visible', 'required'=>true,  'templates' => ['inputContainer' => '{{content}}']]);?>                      
                    ...
                    <div class="col-md-4">
                        <?php 
                            echo $this->Form->control('is_active_acces_creation_event',['label'=>'Accès création d\'évenements']);
                        ?>
                    </div>
                </div>
