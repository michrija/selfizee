                        ...
                        <tbody>
                             <?php $acces = [0=>'Non', 1=>'Oui']; foreach ($users as $key => $user){ 
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?= $this->Html->link('<i class="fa fa-pencil"></i>', ['action' => 'addAcces', $user->id],['escapeTitle'=>false,'aria-expanded'=>'false', 'data-toggle'=>'tooltip','title'=>'Edit' ]) ?>
                                        ...
                                        <?php echo $this->Html->link('<i class="mdi mdi-login"></i>',['action' => 'forceLoginFromAccess', $user->id],['escapeTitle'=>false,'aria-expanded'=>'false', 'data-toggle'=>'tooltip', 'title'=>'Se connecter à ce compte' ]); ?>
