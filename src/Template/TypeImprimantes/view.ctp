...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link(__('Edit Type Imprimante'), ['action' => 'edit', $typeImprimante->id]) ?> </li>
        <li><?= $this->Form->postLink(__('Delete Type Imprimante'), ['action' => 'delete', $typeImprimante->id], ['confirm' => __('Are you sure you want to delete # {0}?', $typeImprimante->id)]) ?> </li>
...
<div class="typeImprimantes view large-9 medium-8 columns content">
    <h3><?= h($typeImprimante->id) ?></h3>
    ...
    <div class="related">
        ...
        <?php if (!empty($typeImprimante->configuration_bornes)): ?>
        <table cellpadding="0" cellspacing="0">
            ...
            <?php foreach ($typeImprimante->configuration_bornes as $configurationBornes): ?>
            <tr>
