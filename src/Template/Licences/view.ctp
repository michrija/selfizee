...
<div class="licences view large-9 medium-8 columns content">
    ...
    <table class="vertical-table">
        ...
        <tr>
            <th scope="row"><?= __('Numero Serie Non Crypte') ?></th>
    ...
    <div class="row">
        <h4><?= __('Numero Serie Crypte') ?></h4>
        <?= $this->Text->autoParagraph(h($licence->numero_serie_crypte)); ?>
    </div>
</div>
