...
<?php $this->start('actionTitle'); ?>
    <div class="pull-right">
        <?= $this->Html->link('<i class="mdi mdi-printer"></i> ' . __('Imprimer rapport de stats'), '/evenements/statistique/'.$evenement->id.'/rapport.pdf' , ['escape' => false, 'class' => 'kl_bntLinkSimple', 'target' => '_blank']); ?>
...
<?php $this->end(); ?>
   ...
   <div class="kl_miseAjour">Date de dernière mise à jour : 
        ...
        <div class="col-lg-6 p-r-0">
            <div class="kl_campagne kl_campagneSms">
                ...
                <div class="chartCampagne">
                    ...
                    <?php } else{ ?>
                        <p class="kl_pasDeCampagagne">Aucune campagne sms</p>
                    <?php } ?>
                </div>
            </div>
        </div>
    ...
    <div class="row kl_blocStatEvent kl_chiffreFacebook">
        ...
        <?php if(count($evenement->facebook_autos)){ ?>
