...
<div class="modelBornes index large-9 medium-8 columns content">
    <h3><?= __('Model Bornes') ?></h3>
    <table cellpadding="0" cellspacing="0">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="actions">
                    <?= $this->Html->link(__('View'), ['action' => 'view', $modelBorne->id]) ?>
                    <?= $this->Html->link(__('Edit'), ['action' => 'edit', $modelBorne->id]) ?>
                    <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $modelBorne->id], ['confirm' => __('Are you sure you want to delete # {0}?', $modelBorne->id)]) ?>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
