...
<div class="contacts view large-9 medium-8 columns content">
    ...
    <table class="vertical-table">
        ...
        <tr>
            <th scope="row"><?= __('Code Pays') ?></th>
            <td><?= h($contact->code_pays) ?></td>
        </tr>
        <tr>
            <th scope="row"><?= __('Photo') ?></th>
            <td><?= $contact->has('photo') ? $this->Html->link($contact->photo->name, ['controller' => 'Photos', 'action' => 'view', $contact->photo->id]) : '' ?></td>
        </tr>
        <tr>
