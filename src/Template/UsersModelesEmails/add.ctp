...
<div class="usersModelesEmails form large-9 medium-8 columns content">
    <?= $this->Form->create($usersModelesEmail) ?>
    <fieldset>
        <legend><?= __('Add Users Modeles Email') ?></legend>
        <?php
            echo $this->Form->control('nom_modele');
            echo $this->Form->control('email_expediteur');
            echo $this->Form->control('nom_expediteur');
            echo $this->Form->control('objet');
            echo $this->Form->control('content');
            echo $this->Form->control('is_photo_en_pj');
