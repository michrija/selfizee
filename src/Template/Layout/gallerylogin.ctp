        ...
        <div class="container">
            <p style="margin: 0;"> 
                <a href="http://www.selfizee.fr">
                    ...
                    <?php else: ?>
                        <?php echo $this->Html->image('logo-noir.png', ['alt' => 'Logo Selfizee','class'=>'img_footer']); ?>
                    <?php endif ?>
                </a><br />
            </p>
            <!--<p>
            ...
            <p>
                <?php
                    $urlSite = "https://www.selfizee.fr";
                    if (isset($client) && !empty($client['url_site_web']) ){
                        $urlSite = $client['url_site_web'];
                    }
                    $hostUrl = parse_url($urlSite, PHP_URL_HOST);

                ?>
                <a class="btn btn-link-site" href="<?= $urlSite ?>" target="_blank"><?= $hostUrl ?></a>
            </p>            
        </div>
    </footer>
