...
<body>
    ...
    <header>
            ...
            <div class="container">
               ...
               <div class="pull-left">
                        <a href="#" class="kl_logoHeader">
                            <img src="<?= $baseUrl ?>webroot/img/logo-galerie-new.png" />
                            <p>
        ...
        <div class="kl_baniereGal" id="id_baniereGal">
                <img src="<?= $this->Url->build($galery->get('url_banniere_souvenir_apercu')) ?>" class="img-responsive" />
    ...
    <div class="kl_contenu">
        ...
        <div class="kl_blocRemerciement">
            ...
            if($galery->is_livredor_active){ 
                echo $this->element('Galeries/commentaires-apercu',['galery'=> $galery]); 
            }
            ?>
            <!--FIN Commentaires-->
        </div>
        ...
        <footer>
            <div class="container">
                <p style="margin: 0;">
                    <a><img src="<?= $baseUrl ?>webroot/img/logo-footer-login-galerie.png" alt="Selfizee" class="img_footer"/></a><br />
                </p>
                <p>
                    <span class="kl-txt-fushia">[</span>
                    <label class="kl-txt-black kl-text-borne">Borne photo événementielle</label>
