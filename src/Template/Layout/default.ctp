...
<head>
    ...
    <?= $this->Html->css('layout.css?t='.time()) ?>
    <?= $this->Html->css('custom.css') ?>
    <?= $this->Html->css('responsive-menu.css') ?>
    <?= $this->Html->css('style2.css') ?>
    
    <!-- You can change the theme colors from here --> 
    <?= $this->Html->css('colors/selfizee.css?t='.time()) ?>
            ...
            <div class="page-content">
                <div class="align-logo ">
                    ...
                    <div class="page-inner-content">
                        <?= $this->element('sous_header'); ?>
                        <?= $this->Flash->render() ?>
                        <div class="row">
                            <div class="col-lg-2 col-modif-lg-2">
                                 <?= $this->element('menu_left', ['evenement'=>$evenement]); ?>
                            </div>
                            <div class="col-lg-10 p-t-5 col-modif-lg-10">
                                <?= $this->fetch('content') ?>
                            </div>
                        </div>
                    </div>
