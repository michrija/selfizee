 ...
 * @var \App\Model\Entity\Multiconfiguration $multiconfiguration
 */
?>
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        <li class="heading"><?= __('Actions') ?></li>
        <li><?= $this->Html->link(__('Edit Multiconfiguration'), ['action' => 'edit', $multiconfiguration->id]) ?> </li>
        <li><?= $this->Form->postLink(__('Delete Multiconfiguration'), ['action' => 'delete', $multiconfiguration->id], ['confirm' => __('Are you sure you want to delete # {0}?', $multiconfiguration->id)]) ?> </li>
        <li><?= $this->Html->link(__('List Multiconfigurations'), ['action' => 'index']) ?> </li>
...
<div class="multiconfigurations view large-9 medium-8 columns content">
    <h3><?= h($multiconfiguration->id) ?></h3>
    ...
    <div class="related">
        ...
        <?php if (!empty($multiconfiguration->configuration_bornes)): ?>
        <table cellpadding="0" cellspacing="0">
            ...
            <?php foreach ($multiconfiguration->configuration_bornes as $configurationBornes): ?>
            <tr>
